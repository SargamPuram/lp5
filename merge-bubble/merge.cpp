...
void bubbleSortParallel(vector<int>& arr) {
    int n = arr.size();
    for (int i = 0; i < n; i++) {
        // Even phase: Compare even-indexed elements with their right neighbors
        ...
        // Odd phase: Compare odd-indexed elements with their right neighbors
        #pragma omp parallel for
